...
use App\Reservas\Reserva\Repository\ReservaServicioRepository;
use App\Reservas\Reserva\Requests\ReservaServicioRequest;
...
class ReservaServicioController extends Controller
{
    ...
    public function byReserva(int $reservaId): JsonResponse
    {
        try {
            // Verificar permisos
            $reserva = app(App\Reservas\Repository\ReservaRepository::class)->findById($reservaId);
