    ...
    private function getFullMenuStructure($incluyeMenuEmprendedor = false)
    {
        $menu = [
            ...
            [
                ...
                'children' => [
                    [
                        'id' => 'reporte-emprendedores-dashboard',
                        'title' => 'Emprendedores Dashboard',
                        'path' => '/admin/reportes/emprendedores/dashboard',
                        'permissions' => ['reporte_read'],
                    ],
                    [
                        'id' => 'reporte-emprendedores-exportacion',
                        'title' => 'Emprendedores Reporte',
                        'path' => '/admin/reportes/emprendedores/exportar',
                        'permissions' => ['reporte_read'],
                    ],
                    [
                        'id' => 'reporte-asociaciones-dashboard',
                        'title' => 'Asociaciones Dashboard',
                        'path' => '/admin/reportes/asociaciones/dashboard',
                        'permissions' => ['reporte_read'],
                    ],
                    [
                        'id' => 'reporte-asociaciones-exportacion',
                        'title' => 'Asociaciones Reporte',
                        'path' => '/admin/reportes/asociaciones/exportar',
                        'permissions' => ['reporte_exportar'],
                    ],
                    [
                        'id' => 'reporte-lugares-dashboard',
                        'title' => 'Lugares Dashboard',
                        'path' => '/admin/reportes/lugares/dashboard',
                        'permissions' => ['reporte_read'],
                    ],
                    [
                        'id' => 'reporte-lugares-exportacion',
                        'title' => 'Lugares Reporte',
                        'path' => '/admin/reportes/lugares/exportar',
                        'permissions' => ['reporte_exportar'],
                    ],
                    [
                        'id' => 'reporte-exportar',
